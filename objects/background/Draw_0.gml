...
// You can write your code in this editor
	...
	try
	{
		...
		for (var i = 0; i < BGData; i++)
		{
			...
			shader_set_uniform_f(Shader.PrlWidth,   600);
			...
			{
				//show_debug_message("");
				/*var imageWidth = sprite_get_width(BGSprites[i]);
				// Ex. If the screen is 512 pixels wide and the image is 100 pixels wide, it'll get drawn 6 times wide
				for (var j = 0; j < screenWidth; j += imageWidth) {
