...
//Skies
scr_draw_background_tiled_area(bg_vv2_2_sky1, 0,  0,  Camera.ViewX * 1 + (cl_speed * 0.40),  Camera.ViewY * globalYScroll + 0 + yOffset ,   global.Width - (cl_speed * 0.50), 135);

scr_draw_background_tiled_area(bg_vv2_2_sky2, 0,  0,  Camera.ViewX * 0.8 + (cl_speed * 0.50),  Camera.ViewY * globalYScroll + 80 + yOffset ,   global.Width - (cl_speed * 0.70), 135);
