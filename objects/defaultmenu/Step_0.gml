			...
			case 1:
			{
				if Input.APress or Input.StartPress
				{
					...
					{	
						...
						if  SlotData != 0
						{
							global.SaveState = SlotData[0];
							global.Character = SlotData[1];
							global.ZoneID	 = SlotData[2];				
							global.SpecialRings = SlotData[3];
							global.RedRings		= SlotData[4];
							global.SpecialRingList = SlotData[9];
							global.RedRingList = SlotData[10];
