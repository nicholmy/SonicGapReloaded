...
// You can write your code in this editor
	...
	#region Data Read
	{
		...
		{	
			...
			{
				var GameCleared   = global.SaveData[i][0];
				var DataCharacter = global.SaveData[i][1];
				var DataZone      = global.SaveData[i][2];				
				var SpecialRings = global.SaveData[i][3];
				var RedRings     = global.SaveData[i][4];
				...
				if !GameCleared
				{
					DisplayData[i] = "SAVE " + string(i + 1) + " - " + string(DataCharacter) + " - ZONE " + string(DataZone) + " - " + "S" + string(SpecialRings) + " C"  + string(RedRings);
				}
				else
				{
					DisplayData[i] = "SAVE " + string(i + 1) + " - " + string(DataCharacter) + " - CLEAR " + " - " + "S" + string(SpecialRings) + " C"  + string(RedRings);
				}
			}
		}
	}
