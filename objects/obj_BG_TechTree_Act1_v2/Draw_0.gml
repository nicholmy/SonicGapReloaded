...
scr_draw_background_tiled_area(bg_tt1_tree4, 0, 0,  Camera.ViewX * 0.9,  Camera.ViewY * (globalYScroll - 0.0) + 250 + yOffset ,  Camera.ViewX * 0.1 +  global.Width, 322);
scr_draw_background_tiled_area(bg_tt1_bush, 0, 0,  Camera.ViewX * 0.8,  Camera.ViewY * (globalYScroll - 0.0) + 430 + yOffset ,  Camera.ViewX * 0.2 +  global.Width, 179);
scr_draw_background_tiled_area(bg_tt1_tree1, 0, 0,  Camera.ViewX * 0.7,  Camera.ViewY * (globalYScroll - 0.0) + 60 + yOffset ,  Camera.ViewX * 0.3 +  global.Width, 643);
