...
event_inherited();
 ...
 // Draw the Clouds
    scr_draw_background_tiled_area(bg_doomsday_planet1, 0, 0,  Camera.ViewX * 0.9 + (cl_speed * 0.60),  Camera.ViewY * 0.97 + 177,  Camera.ViewX * 0.1 + global.Width - (cl_speed * 0.60), 47);
    scr_draw_background_tiled_area(bg_doomsday_planet2, 0, 0,  Camera.ViewX * 0.89 + (cl_speed * 0.70),  Camera.ViewY * 0.97 + 224,  Camera.ViewX * 0.11 + global.Width - (cl_speed * 0.70), 62);
	scr_draw_background_tiled_area(bg_doomsday_planet3, 0, 0,  Camera.ViewX * 0.88 + (cl_speed * 0.80),  Camera.ViewY * 0.97 + 286,  Camera.ViewX * 0.12 + global.Width - (cl_speed * 0.80), 84);