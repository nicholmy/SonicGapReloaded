...
// You can write your code in this editor
	...
	if DebugVariables
	{
		...
		draw_text_ext_transformed(global.Width - 86, 8,
					...
					"         ORBINAUT  FRAMEWORK"
				+ "\n            DEBUG SCREEN"
				+ "\n   RED RINGS: "	      + string(global.RedRings)
				+ "\n   SPECIAL RINGS: "	      + string(global.SpecialRings)
				+ "\n"
				+ "\n          * PLAYER MOTION *"
				...
				+ "\n   EVENT MSG: "	   + string(Stage.EventMessage)
				+ "\n   EVENT TIME: "	   + string(Stage.EventTimer)
				+ "\n   CHAIN COUNT: "	   + string(Stage.GapChainCount)
				+ "\n   COMBO TOTAL: "		   + string(Stage.GapComboTotal)
				+ "\n   COMBO TIME: "		   + string(Stage.ComboTimeLeft)
				+ "\n   CURRENT GAP: "	   + string(Stage.CurrentGapID)
				+ "\n   GAP NAME: "		   + string(Stage.CurrentGapName)
				+ "\n   GAP TYPE: "		   + string(Stage.CurrentGapType)
				+ "\n   GAP STATE: "	   + string(Stage.CurrentGapState)
				+ "\n   CURRENT TRIGGER: "	   + string(Stage.CurrentTriggerID)
				+ "\n   CURRENT SONIC ID: "	   + string(Stage.CurrentSONICID),
